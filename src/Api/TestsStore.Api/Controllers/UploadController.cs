...
namespace TestsStore.Api.Controllers
{
	...
	public class UploadController : Controller
	{
		...
		[Route("trx")]
		public async Task<ActionResult> TrxUpload([FromForm]string project, [FromForm] string build)
		{
			...
			string testResultDirectory = $"{webRootPath}\\TestResults";
			...
			string filePath = $"{testResultDirectory}\\{fileName}";
			...
			var q = (TestRun)serializer.Deserialize(reader);
